...
LOAD DATA INFILE 'C:\\wamp64\\tmp\\REGIONS.csv'
...
LOAD DATA INFILE 'C:\\wamp64\\tmp\\PAYS.csv'
...
LOAD DATA INFILE 'C:\\wamp64\\tmp\\BUREAUX.csv'
...
LOAD DATA INFILE 'C:\\wamp64\\tmp\\EMPLOYES.csv'
...
LOAD DATA INFILE 'C:\\wamp64\\tmp\\DEPARTEMENTS.csv'
...
LOAD DATA INFILE 'C:\\wamp64\\tmp\\EMPLOIS.csv'
...
LOAD DATA INFILE 'C:\\wamp64\\tmp\\HISTORIQUE_EMPLOIS.csv'
...
SELECT ID_REGION, NOM_REGION FROM temp_region;

INSERT INTO pays (ID_PAYS, NOM_PAYS, ID_REGION)
SELECT ID_PAYS, NOM_PAYS, ID_REGION FROM temp_pays;

INSERT INTO bureau (ID_BUREAU, ADRESSE_RUE_BUREAU, CODE_POSTAL_BUREAU, NOM_VILLE_BUREAU, COURRIEL_BUREAU, ID_PAYS)
SELECT ID_BUREAU, ADRESSE_RUE_BUREAU, CODE_POSTAL_BUREAU, NOM_VILLE_BUREAU, COURRIEL_BUREAU, ID_PAYS FROM temp_bureau;

INSERT INTO employe (ID_EMPLOYE, PRENOM_EMPLOYE, NOM_EMPLOYE, COURRIEL_EMPLOYE, ADRESSE_RUE_EMPLOYE, ADRESSE_VILLE_EMPLOYE, ADRESSE_CP_EMPLOYE, RESPONSABLE_EMPLOYE)
SELECT ID_EMPLOYE, PRENOM_EMPLOYE, NOM_EMPLOYE, COURRIEL_EMPLOYE, ADRESSE_RUE_EMPLOYE, ADRESSE_VILLE_EMPLOYE, ADRESSE_CP_EMPLOYE, RESPONSABLE_EMPLOYE FROM temp_employe;

INSERT INTO departement (ID_DEPARTEMENT, NOM_DEPARTEMENT, DIRECTEUR_DEPARTEMENT, ID_BUREAU)
SELECT ID_DEPARTEMENT, NOM_DEPARTEMENT, DIRECTEUR_DEPARTEMENT, ID_BUREAU FROM temp_departement;

INSERT INTO emploi (ID_EMPLOI, TITRE_EMPLOI, SALAIRE_MINIMUM, SALAIRE_MAXIMUM)
SELECT ID_EMPLOI, TITRE_EMPLOI, SALAIRE_MINIMUM, SALAIRE_MAXIMUM FROM temp_emploi;

INSERT INTO historique_emploi (ID_EMPLOYE, ID_EMPLOI, DATE_DEBUT_EMPLOI, DATE_FIN_EMPLOI, ID_DEPARTEMENT, SALAIRE)
SELECT ID_EMPLOYE, ID_EMPLOI, DATE_DEBUT_EMPLOI, DATE_FIN_EMPLOI, ID_DEPARTEMENT, SALAIRE FROM temp_historique_emploi;
