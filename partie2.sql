...
LOAD DATA INFILE '/Users/yanimeziani/Desktop/BD - TP FINAL/REGIONS.csv'
INTO TABLE temp_region
FIELDS TERMINATED BY ';' 
LINES TERMINATED BY '\n'
IGNORE 1 LINES;

LOAD DATA INFILE '/Users/yanimeziani/Desktop/BD - TP FINAL/PAYS.csv'
INTO TABLE temp_pays
FIELDS TERMINATED BY ';' 
LINES TERMINATED BY '\n'
IGNORE 1 LINES;

LOAD DATA INFILE '/Users/yanimeziani/Desktop/BD - TP FINAL/BUREAUX.csv'
INTO TABLE temp_bureau
FIELDS TERMINATED BY ';' 
LINES TERMINATED BY '\n'
IGNORE 1 LINES
(@skip, ID_BUREAU, ID_PAYS, ADRESSE_RUE_BUREAU, CODE_POSTAL_BUREAU, NOM_VILLE_BUREAU, COURRIEL_BUREAU)
SET skip = IF(CHAR_LENGTH(CODE_POSTAL_BUREAU) <= 12, 1, 0);

LOAD DATA INFILE '/Users/yanimeziani/Desktop/BD - TP FINAL/EMPLOYES.csv'
INTO TABLE temp_employe
FIELDS TERMINATED BY ';' 
LINES TERMINATED BY '\n'
IGNORE 1 LINES;

LOAD DATA INFILE '/Users/yanimeziani/Desktop/BD - TP FINAL/DEPARTEMENTS.csv'
INTO TABLE temp_departement
FIELDS TERMINATED BY ';' 
LINES TERMINATED BY '\n'
IGNORE 1 LINES;

LOAD DATA INFILE '/Users/yanimeziani/Desktop/BD - TP FINAL/EMPLOIS.csv'
INTO TABLE temp_emploi
FIELDS TERMINATED BY ';' 
LINES TERMINATED BY '\n'
IGNORE 1 LINES;

LOAD DATA INFILE '/Users/yanimeziani/Desktop/BD - TP FINAL/HISTORIQUE_EMPLOIS.csv'
